...
public class PlayState extends Screen {
    ...
    private void onNewLevel(){
        switch (level){
            ...
            case 3:
                map = resources.getLevel(ResourceManager.mapLevel3);
            case 4:
                map = resources.getLevel(ResourceManager.mapLevel4);
            case 5:
                map = resources.getLevel(ResourceManager.mapLevel5);
            case 6:
                map = resources.getLevel(ResourceManager.mapLevel6);
            case 7:
                map = resources.getLevel(ResourceManager.mapLevel7);
            case 8:
                map = resources.getLevel(ResourceManager.mapLevel8);	
            case 9:
                map = resources.getLevel(ResourceManager.mapLevel9);
            case 10:
                map = resources.getLevel(ResourceManager.mapLevel10);
            case 11:
                map = resources.getLevel(ResourceManager.mapLevel11);
            case 12:
                map = resources.getLevel(ResourceManager.mapLevel12);
            case 13:
                map = resources.getLevel(ResourceManager.mapLevel13);
            case 14:
                map = resources.getLevel(ResourceManager.mapLevel14);	
            case 15:
                map = resources.getLevel(ResourceManager.mapLevel15);
            case 16:
                map = resources.getLevel(ResourceManager.mapLevel16);				
