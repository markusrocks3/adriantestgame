...
public class ResourceManager {
    ...
    public static final String mapLevel2 = levelsPath + "level2.tmx";
	 public static final String mapLevel3 = levelsPath + "level3.tmx";
 public static final String mapLevel4 = levelsPath + "level4.tmx";
  public static final String mapLevel5 = levelsPath + "level5.tmx";
   public static final String mapLevel6 = levelsPath + "level6.tmx";
    public static final String mapLevel7 = levelsPath + "level7.tmx";
	 public static final String mapLevel8 = levelsPath + "level8.tmx";
	  public static final String mapLevel9 = levelsPath + "level9.tmx";
	   public static final String mapLevel10 = levelsPath + "level10.tmx";
	    public static final String mapLevel11 = levelsPath + "level11.tmx";
		 public static final String mapLevel12 = levelsPath + "level12.tmx";
		  public static final String mapLevel13 = levelsPath + "level13.tmx";
		   public static final String mapLevel14 = levelsPath + "level14.tmx";
		    public static final String mapLevel15 = levelsPath + "level15.tmx";
			 public static final String mapLevel16 = levelsPath + "level16.tmx";
    ...
    private void loadMaps(){
        ...
        manager.load(mapLevel3, TiledMap.class);
        manager.load(mapLevel4, TiledMap.class);
        manager.load(mapLevel5, TiledMap.class);
        manager.load(mapLevel6, TiledMap.class);
        manager.load(mapLevel7, TiledMap.class);
        manager.load(mapLevel8, TiledMap.class);
        manager.load(mapLevel9, TiledMap.class);
        manager.load(mapLevel10, TiledMap.class);
        manager.load(mapLevel11, TiledMap.class);
        manager.load(mapLevel12, TiledMap.class);
        manager.load(mapLevel13, TiledMap.class);
        manager.load(mapLevel14, TiledMap.class);
        manager.load(mapLevel15, TiledMap.class);
        manager.load(mapLevel16, TiledMap.class);
    }
